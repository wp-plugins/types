...
function wpcf_fields_skype_meta_box_form($field) {
    ...
    $preview_skypename = isset($field['value']['skypename']) ? $field['value']['skypename'] : 'test';
...
function wpcf_fields_skype_meta_box_ajax() {
    ...
    <form method="post" action="">
        <div id="paddedContent"> 
            <div id="step1"> 
                <h2><?php _e('Enter your Skype Name',
            'wpcf'); ?></h2>  
                <p> 
            ...
            <div id="step2"> 
                <h2><?php _e('Select a button from below',
                        'wpcf'); ?></h2>  
                        ...
                        <colgroup><col span="1" width="223">
                            <col span="1" width="222">
                                ...
                                <td colspan="1" rowspan="1"> 
                                    <label for="btn1"> 
                                        <input <?php if ($_GET['style'] == 'btn1')
                    echo 'checked="checked" '; ?>id="btn1" name="buttonstyle" tabindex="2" value="btn1" type="radio" />  
                                ...
                                <td colspan="1" rowspan="1"> 
                                    <label for="btn2"> 
                                        <input <?php if ($_GET['style'] == 'btn2')
                    echo 'checked="checked" '; ?>id="btn2" name="buttonstyle" tabindex="3" value="btn2" type="radio" />  
                            ...
                            <tr>
                                <td colspan="1" rowspan="1"> 
                                    <label for="btn3"> 
                                        <input <?php if ($_GET['style'] == 'btn3')
                    echo 'checked="checked" '; ?>id="btn3" name="buttonstyle" tabindex="4" value="btn3" type="radio" />  
                                ...
                                <td colspan="1" rowspan="1"> 
                                    <label for="btn4"> 
                                        <input <?php if ($_GET['style'] == 'btn4')
                    echo 'checked="checked" '; ?>id="btn4" name="buttonstyle" tabindex="5" value="btn4" type="radio" />  
                ...
                <h2><?php _e('Skype buttons with status',
                        'wpcf'); ?></h2>  
                <p><?php _e('If you choose to show your Skype status, your Skype button will always reflect your availability on Skype. This status will be shown to everyone, whether they’re in your contact list or not.',
                        'wpcf'); ?></p>  
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="445">
                        <colgroup><col span="1" width="223">
                            <col span="1" width="222">
                                ...
                                <td colspan="1" rowspan="1"> 
                                    <label for="btn5"> 
                                        <input <?php if ($_GET['style'] == 'btn5')
                    echo 'checked="checked" '; ?>id="btn5" name="buttonstyle" tabindex="6" value="btn5" type="radio" />  
                                        <img alt="" id="btn5-img" src="http://www.skypeassets.com/i/legacy/images/share/buttons/anim_balloon.gif" height="60" width="150" /> 
                                    </label> 
                                </td>
                                <td colspan="1" rowspan="1"> 
                                    <label for="btn6"> 
                                        <input <?php if ($_GET['style'] == 'btn6')
                    echo 'checked="checked" '; ?>id="btn6" name="buttonstyle" tabindex="7" value="btn6" type="radio" />  
    ...
    <?php wp_nonce_field('wpcf-form',
            '_wpnonce_wpcf_form'); ?>
            <br /><br /><input type="submit" class="button-primary" value="<?php _e('Insert skype button',
            'wpcf'); ?>" />
    </form>
    <?php
