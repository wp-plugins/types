...
function wpcf_admin_custom_taxonomies_form() {
    ...
    $labels = array(
        'search_items' => array('title' => __('Search %s'), 'description' => __("The search items text. Default is __( 'Search Tags' ) or __( 'Search Categories' ).",
                    'wpcf')),
        'popular_items' => array('title' => __('Popular %s'), 'description' => __("The popular items text. Default is __( 'Popular Tags' ) or null.",
                    'wpcf')),
        'all_items' => array('title' => __('All %s'), 'description' => __("The all items text. Default is __( 'All Tags' ) or __( 'All Categories' ).",
                    'wpcf')),
        'parent_item' => array('title' => __('Parent %s'), 'description' => __("The parent item text. This string is not used on non-hierarchical taxonomies such as post tags. Default is null or __( 'Parent Category' ).",
                    'wpcf')),
        'parent_item_colon' => array('title' => __('Parent %s:'), 'description' => __("The same as parent_item, but with colon : in the end null, __( 'Parent Category:' ).",
                    'wpcf')),
        'edit_item' => array('title' => __('Edit %s'), 'description' => __("The edit item text. Default is __( 'Edit Tag' ) or __( 'Edit Category' ).",
                    'wpcf')),
        'update_item' => array('title' => __('Update %s'), 'description' => __("The update item text. Default is __( 'Update Tag' ) or __( 'Update Category' ).",
                    'wpcf')),
        'add_new_item' => array('title' => __('Add New %s'), 'description' => __("The add new item text. Default is __( 'Add New Tag' ) or __( 'Add New Category' ).",
                    'wpcf')),
        'new_item_name' => array('title' => __('New %s Name'), 'description' => __("The new item name text. Default is __( 'New Tag Name' ) or __( 'New Category Name' ).",
                    'wpcf')),
        'separate_items_with_commas' => array('title' => __('Separate %s with commas'), 'description' => __("The separate item with commas text used in the taxonomy meta box. This string isn't used on hierarchical taxonomies. Default is __( 'Separate tags with commas' ), or null.",
                    'wpcf')),
        'add_or_remove_items' => array('title' => __('Add or remove %s'), 'description' => __("the add or remove items text and used in the meta box when JavaScript is disabled. This string isn't used on hierarchical taxonomies. Default is __( 'Add or remove tags' ) or null.",
                    'wpcf')),
        'choose_from_most_used' => array('title' => __('Choose from the most used %s'), 'description' => __("The choose from most used text used in the taxonomy meta box. This string isn't used on hierarchical taxonomies. Default is __( 'Choose from the most used tags' ) or null.",
                    'wpcf')),
