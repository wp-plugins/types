...
= 0.9.5.2 =
* Fixed a bug with image resize on non-Linux servers (Mac and Windows)
* Changed the default status of Types credit footer

= 0.9.5.3 =
* Version bump to reset the WP listing page
